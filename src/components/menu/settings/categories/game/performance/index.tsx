...
import {
  ANTIALIASING_HINT,
  CULLING_HINT,
  FOOD_PERFORMANCE_MODE_HINT,
  RENDER_MODE_HINT,
} from 'redux/settings/game/performance/hints';
...
const mapDispatchToProps = (dispatch: ThunkRootDispatchType) => ({
  ...
  setGlowFilterShaderType: (type: GlowFilterShaderType) =>
    dispatch(thunkSetGlowFilterShaderType(type)),

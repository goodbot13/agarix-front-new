...
const Minimap: FC<MinimapType> = ({
  ...
  return (
    <>
      ...
      />
      <Colorpick text="Player color" color={playerColor} onChange={setMinimapPlayerColor} />
      <Colorpick
...
const mapDispatchToProps = (dispatch: ThunkRootDispatchType) => ({
  ...
  setMinimapTopOneViewportColor: (color: RGB) =>
    dispatch(thunkSetMinimapTopOneViewportColor(color)),

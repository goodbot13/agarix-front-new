...
export type UIActionTypes =
  | SetGameLoadedAction
  | SetGameLoaderStatusAction
  | SetMenuShownAction
  | SetUIBluredAction
  | SetSettingsShownAction
  | SetSettingsTypeAction
  | SetGameSettingsSubmenuAction
  | SetLeaderboardPlayersAction
  | SetThemingSettingsSubmenuAction
  | SetAdditionalProfilesListShownAction
  | SetHotkeysSettingsSubmenuAction
  | SetStatsAction
  | SetSettingsUIType
  | SetGameSocketConnectingAction
  | AddChatMessageAction
  | SetTopTeamPlayersAction
  | SetHudsShown
  | SetSpectateType
  | SetIsPlayerPlaying
  | SetInputMessageShown;

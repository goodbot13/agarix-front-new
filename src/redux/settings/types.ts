...
export type SettingsActionTypes = GamePerformanceActionTypes | GameCellsActionTypes | GameGameplayActionTypes | 
                                  GameMultiboxActionTypes | GameEffectsActionTypes | ThemingCellsActionTypes | 
                                  ThemingFoodActionTypes | ThemingVirusesActionTypes | ThemingMinimapActionTypes | 
                                  ThemingMapActionTypes | ThemingMultiboxActionTypes  | HotkeysKeyboardActionTypes;
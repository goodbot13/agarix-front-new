...
import {
  FpsLockType,
  GamePerformanceThunkActionTypes,
  GlowFilterShaderType,
  RenderModeType,
} from './types';

export const thunkSetRenderMode = (renderMode: RenderModeType): GamePerformanceThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetAntialiasing = (enabled: boolean): GamePerformanceThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetCulling = (culling: boolean): GamePerformanceThunkActionTypes => (
  dispatch,
) => {
  dispatch(setCulling(culling));
};

export const thunkSetFoodPerformanceMode = (enabled: boolean): GamePerformanceThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetGlowFilterShaderType = (
  type: GlowFilterShaderType,
): GamePerformanceThunkActionTypes => (dispatch) => {
  dispatch(setGlowFilterShaderType(type));
  GamePerformanceSettings.setGlowFilterShaderType(type);
};

export const thunkSetFpsLockType = (type: FpsLockType): GamePerformanceThunkActionTypes => (
  dispatch,
) => {

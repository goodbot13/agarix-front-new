...
export type GameGameplayActionTypes =
  | SetAnimationSpeedAction
  | SetZoomSpeedAction
  | SetCameraSpeedAction
  | SetCameraStyleAction
  | SetSpectatorModeAction
  | SetViewportAction;

export type GameGameplayThunkActionTypes = ThunkAction<
  void,
  AppStateType,
  unknown,
  GameGameplayActionTypes | UIActionTypes
>;

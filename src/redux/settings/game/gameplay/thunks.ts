...
export const thunkSetAnimationSpeed = (animationSpeed: number): GameGameplayThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetZoomSpeed = (zoomSpeed: number): GameGameplayThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetCameraSpeed = (cameraSpeed: number): GameGameplayThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetCameraStyle = (cameraStyle: CameraStyleType): GameGameplayThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetSpectatorMode = (
  spectatorMode: SpectatorModeType,
): GameGameplayThunkActionTypes => (dispatch) => {
...
export const thunkSetViewport = (viewport: ViewportType): GameGameplayThunkActionTypes => (
  dispatch,
) => {

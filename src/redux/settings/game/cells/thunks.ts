...
export const thunkSetShowMassMyCell = (myMass: boolean): GameCellsThunkActionTypes => (
  disaptch,
) => {
...
export const thunkSetShowNickMyCell = (myNick: boolean): GameCellsThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetAutoHideMassAndNicks = (
  autoHideMassAndNicks: boolean,
): GameCellsThunkActionTypes => (dispatch) => {
...
export const thunkSetMassUpdateDelay = (massUpdateDelay: number): GameCellsThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetSkinsType = (skinsType: SkinsType): GameCellsThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetRingsType = (ringsType: RingsType): GameCellsThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetRingsSpinning = (ringsSpinning: boolean): GameCellsThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetOneColored = (oneColored: boolean): GameCellsThunkActionTypes => (
  dispatch,
) => {

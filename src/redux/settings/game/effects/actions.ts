...
export const setCellRemoveAnimation = (cellRemoveAnimation: CellRemoveAnimationType): GameEffectsActionTypes => ({
  type: SET_CELL_REMOVE_ANIMATION,
  cellRemoveAnimation
});

export const setCellRemoveAnimationForHiddenSpectator = (cellRemoveAnimationForHiddenSpectator: boolean): GameEffectsActionTypes => ({

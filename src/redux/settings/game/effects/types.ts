...
export const SET_CELL_REMOVE_ANIMATION_FOR_HIDDEN_SPECTATOR = 'SET_CELL_REMOVE_ANIMATION_FOR_HIDDEN_SPECTATOR';
...
export type GameEffectsActionTypes = SetCellRemoveAnimationAction | SetCellRemoveAnimationForHiddenSpectatorAction |
                                     SetSpawnAnimationAction | SetWtfRgbModeAction;

export type GameEffectsThunkActionTypes = ThunkAction<void, AppStateType, unknown, GameEffectsActionTypes>;
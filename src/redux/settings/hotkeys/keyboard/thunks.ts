...
export const thunkSetSplitSixteen = (key: string): HotkeysKeyboardThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetQuickRespawn = (key: string): HotkeysKeyboardThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetToggleCellHelpers = (key: string): HotkeysKeyboardThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetToggleCellSkins = (key: string): HotkeysKeyboardThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetToggleCellRings = (key: string): HotkeysKeyboardThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetToggleFoodRender = (key: string): HotkeysKeyboardThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetToggleSpectatorMode = (key: string): HotkeysKeyboardThunkActionTypes => (
  dispatch,
) => {

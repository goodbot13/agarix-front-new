...
export const SET_MAP_BACKGROUND_IMAGE_LIVE_EFFECT_STRENGTH =
...
export const SET_MAP_GLOBAL_BACKGROUND_IMAGE_LIVE_EFFECT_STRENGTH =
...
export type ThemingMapActionTypes =
  | SetMapBorderTypeAction
  | SetMapBorderRoundnessAction
  | SetMapBorderWidthAction
  | SetMapBorderColorAction
  | SetMapBorderGlowAction
  | SetMapBorderGlowColorAction
  | SetMapBorderGlowDistanceAction
  | SetMapBorderGlowStrengthAction
  | SetMapBackgroundTintAction
  | SetMapBackgroundImageAction
  | SetMapBackgroundImageUrlAction
  | SetMapBackgroundImageTintAction
  | SetMapBackgroundImageLiveEffectStrengthAction
  | SetMapGlobalBackgroundImageAction
  | SetMapGlobalBackgroundImageUrlAction
  | SetMapGlobalBackgroundImageTintAction
  | SetMapGlobalBackgroundImageLiveEffectStrengthAction;

export type ThemingMapThunkActionTypes = ThunkAction<
  void,
  AppStateType,
  unknown,

...
export const setMapGlobalBackgroundImage = (globalBackgroundImage: boolean): ThemingMapActionTypes => ({
  type: SET_MAP_GLOBAL_BACKGROUND_IMAGE,
  globalBackgroundImage 
});

export const setMapGlobalBackgroundImageUrl = (globalBackgroundImageUrl: string): ThemingMapActionTypes => ({
  type: SET_MAP_GLOBAL_BACKGROUND_IMAGE_URL,
  globalBackgroundImageUrl
});

export const setMapGlobalBackgroundImageTint = (globalBackgroundImageTint: RGB): ThemingMapActionTypes => ({

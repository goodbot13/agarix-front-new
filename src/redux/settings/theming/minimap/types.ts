...
export type ThemingMinimapActionTypes =
  | SetMinimapBackgroundColorAction
  | SetMinimapSizeAction
  | SetMinimapMyViewportColorAction
  | SetMinimapTopOneViewportColorAction
  | SetMinimapPlayerSizeAction
  | SetMinimapPlayerColorAction
  | SetMinimapGhostCellsColorAction;

export type ThemingMinimapThunkActionTypes = ThunkAction<
  void,
  AppStateType,
  unknown,

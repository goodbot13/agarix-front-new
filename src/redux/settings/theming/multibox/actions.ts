...
export const setMultiboxRingStyle = (ringStyle: MultiboxRingStyleType): ThemingMultiboxActionTypes => ({
...
export const setMultiboxInitialStaticCellColor = (initialStaticCellColor: RGB): ThemingMultiboxActionTypes => ({
  type: SET_MULTIBOX_INITIAL_STATIC_CELL_COLOR,
  initialStaticCellColor 
});

export const setMultiboxFocusedStaticCellColor = (focusedStaticCellColor: RGB): ThemingMultiboxActionTypes => ({

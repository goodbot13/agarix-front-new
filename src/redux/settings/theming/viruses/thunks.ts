...
export const thunkSetVirusBorderWidth = (borderWidth: number): ThemingVirusesThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetVirusBorderColor = (borderColor: RGB): ThemingVirusesThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetVirusGlowColor = (glowColor: RGB): ThemingVirusesThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetVirusGloDistance = (glowDistance: number): ThemingVirusesThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetVirusGlowStrength = (glowStrength: number): ThemingVirusesThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetVirusTransparency = (transparency: number): ThemingVirusesThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetVirusMassType = (massType: VirusMassType): ThemingVirusesThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetFillCircleColor = (fillCircleColor: RGB): ThemingVirusesThunkActionTypes => (
  dispatch,
) => {

...
export type ThemingCellsActionTypes =
  | SetOneColoredColorAction
  | SetOneColoredStatsColorAction
  | SetShadowColorAction
  | SetMyShadowColorAction
  | SetShadowDistanceAction
  | SetShadowStrengthAction
  | SetCellsTransparencyAction
  | SetCellsColorLightenAction
  | SetMyShadowDistanceAction
  | SetMyShadowStrengthAction
  | SetAdaptiveShadowAction;

export type ThemingCellsThunkActionTypes = ThunkAction<
  void,
  AppStateType,
  unknown,

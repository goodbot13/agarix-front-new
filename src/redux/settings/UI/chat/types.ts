...
export const SET_CHAT_COMMAND_MESSAGE_BACKGROUND_COLOR =
...
export type UIChatActionTypes =
  | SetEnabledAction
  | SetBackgroundColorAction
  | SetHeightAction
  | SetCommandMessageBackgroundColorAction
  | SetTypeAction
  | SetFontColorAction
  | SetCommandMessageFontColorAction
  | SetGameMessageBackgroundColorAction
  | SetGameMessageFontColorAction;

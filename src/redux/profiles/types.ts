...
export type ProfilesActionTypes =
  | SetLeftProfileNickAction
  | SetLeftProfileSkinUrlAction
  | SetLeftProfileSelectedIndexAction
  | SetRightProfileSkinUrlAction
  | SetRightProfileNickAction
  | SetRightProfileSelectedIndexAction
  | SetTagAction
  | SetLeftProfileLoginTypeAction
  | SetRightProfileLoginTypeAction
  | SetFacebookLoggedInAction
  | SetGoogleLoggedInAction;

export type ProfilesThunkActionTypes = ThunkAction<
  void,
  AppStateType,
  unknown,
  ProfilesActionTypes

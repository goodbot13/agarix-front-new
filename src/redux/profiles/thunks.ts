...
export const thunkSetLeftProfileSelectedIndex = (i: number): ProfilesThunkActionTypes => (
  dispatch,
  getState,
) => {
...
export const thunkSetRightProfileSkinUrl = (url: string): ProfilesThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetRightProfileSelectedIndex = (i: number): ProfilesThunkActionTypes => (
  dispatch,
  getState,
) => {
...
export const thunkSetLeftProfileLoginType = (loginType: TLoginType): ProfilesThunkActionTypes => (
  dispatch,
) => {
...
export const thunkSetRightProfileLoginType = (loginType: TLoginType): ProfilesThunkActionTypes => (
  dispatch,
) => {
